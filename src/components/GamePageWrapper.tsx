...
export default function GamePageWrapper({ project, user }: GamePageWrapperProps) {
  ...
  const publicUrl = `/dashboard/projects/${project.id}/public`

  return (
    // Fixed full-screen overlay that covers the entire viewport including sidebar
    <div className="fixed inset-0 z-50 bg-gradient-to-b from-background to-muted/30 overflow-auto">
      {/* Custom TopBar with Workspace/Game Page toggle */}
